    ...
    <>
      <Container>
        ...
        <h1 style={{ textAlign: "center" }}>
          Privacy Policy for social banner maker
        </h1>
        ...
        <p>
          ...
          shared and/or collect in social banner maker. This policy is not
        ...
        <p>
          social banner maker follows a standard procedure of using log files.
        ...
        <p>
          ...
          advertising partners of social banner maker.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on social banner maker, which are
        ...
        <p>
          Note that social banner maker has no access to or control over these
        ...
        <p>
          social banner makers Privacy Policy does not apply to other
        ...
        <p>
          social banner maker does not knowingly collect any Personal
        ...
        <p>
          ...
          to reach out to us at socialbanner@gmail.com. We value your input and
