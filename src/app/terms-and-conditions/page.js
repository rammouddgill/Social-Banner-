  ...
  return (
    <Container>
      ...
      <h1 style={{ textAlign: "center" }}>
        Terms and Conditions for social banner maker
      </h1>
      ...
      <p>
        ...
        https://social-banner.netlify.app/.
      </p>
      ...
      <p>
        Other than the content you own, under these Terms, social banner maker
      ...
      <p>
        ...
        and social banner maker may further restrict access by you to any areas
      ...
      <p>
        ...
        this Website. By displaying Your Content, you grant social banner maker
      ...
      <p>
        ...
        rights. social banner maker reserves the right to remove any of Your
      ...
      <p>
        This Website is provided as is, with all faults, and social banner maker
      ...
      <p>
        In no event shall social banner maker, nor any of its officers,
        ...
        liability is under contract. social banner maker, including its
      ...
      <p>
        You hereby indemnify to the fullest extent social banner maker from and
      ...
      <p>
        social banner maker is permitted to revise these Terms at any time as it
      ...
      <p>
        The social banner maker is allowed to assign, transfer, and subcontract
      ...
      <p>
        These Terms constitute the entire agreement between social banner maker
